    ...
    <ClientLayout>
        <header class="mx-auto max-w-6xl px-4 pt-12 pb-14 sm:px-6 sm:pt-16">
            ...
            >
                ...
                >
                    Tiếp cận hàng nghìn khách hàng tiềm năng mỗi ngày với tin
                    đăng nổi bật, hỗ trợ hình ảnh sắc nét và báo cáo hiệu quả
                    theo thời gian thực.
                </p>
                <div
            ...
            <section class="grid gap-6 lg:grid-cols-3">
                    ...
                    <div class="space-y-3 px-6 py-5 text-sm">
                        ...
                        >
                            ...
                            <div>
                                ...
                                <p class="font-semibold text-slate-800">Thấp</p>
                            </div>
                        </div>
                        <div
                            class="flex gap-3 border-b border-dashed border-slate-100 pb-3"
                    ...
                    <div class="space-y-3 px-6 py-5 text-sm">
                        ...
                        >
                            ...
                            <div>
                                ...
                                <p class="font-semibold text-slate-800">Có</p>
                            </div>
                        </div>
                        <div
                            class="flex gap-3 border-b border-dashed border-slate-100 pb-3"
                        ...
                        >
                            ...
                            <div>
                                ...
                                <p class="font-semibold text-slate-800">Cao</p>
                            </div>
                        </div>
                        <div
                            class="flex gap-3 border-b border-dashed border-slate-100 pb-3"
                ...
                >
                    <div class="border-b border-slate-100 px-6 py-6">
                        ...
                        <p class="mt-1 text-xs text-slate-500">3 tháng</p>
                        <div class="mt-4 flex items-end gap-1">
                            <span class="text-4xl font-extrabold text-pink-900"
                                >349K</span
                            >
                            <span class="pb-1 text-xs text-slate-500"
                                >/ tháng</span
            ...
            >
                ...
                <div class="overflow-x-auto">
                    <table class="min-w-full text-sm">
                        ...
                        >
                            <tr>
                                <th class="px-4 py-3 text-left">Tính năng</th>
                                ...
                                <th class="px-4 py-3 text-center text-pink-900">
                                    SVIP (3 tháng)
                                </th>
                            </tr>
                        </thead>
